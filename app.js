...
function runEvent(e) {
    if (taskInput.value <= 5 &&  maleRadioButton.checked){
      console.log('Boy');
      answer.innerHTML = '<p>Receives: <span class ="text">5 SHEKELS OF SILVER! <span></p>'
    } else if (taskInput.value <= 5 && femaleRadioButton.checked){
      console.log('Girl');
      answer.innerHTML = '<p>Receives: <span class ="text">3 SHEKELS OF SILVER! <span></p>'

    } else if(taskInput.value > 5 && taskInput.value <= 20 && maleRadioButton.checked){
      console.log('Man');
      answer.innerHTML = '<p>Receives: <span class ="text">20 SHEKELS OF SILVER! <span></p>'
    } else if(taskInput.value > 5 && taskInput.value <= 20 && femaleRadioButton.checked){
      console.log('Woman');
      answer.innerHTML = '<p>Receives: <span class ="text">10 SHEKELS OF SILVER! <span></p>'

    }else if(taskInput.value > 20 && taskInput.value <= 60 && maleRadioButton.checked){
      console.log('OldMan');
      answer.innerHTML = '<p>Receives: <span class ="text">50 SHEKELS OF SILVER! <span></p>'
      ...
      console.log('OldMan');
      answer.innerHTML = '<p>Receives: <span class ="text">15 SHEKELS OF SILVER! <span></p>'
      ...
      console.log('No');
      answer.innerHTML ='<pre class="text3">Please Enter A Number!</pre>';
    }else{
      console.log('wrong');
      answer.innerHTML = '<span class="text2">No Gender Selected!</span>'
    }
